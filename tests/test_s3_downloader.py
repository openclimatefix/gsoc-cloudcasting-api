...
class TestConversionFunctions:
    ...
    def test_convert_zarr_to_geotiffs_success(self, mock_save, mock_extract, mock_open_zarr):
...
class TestTimestampFunctions:
    ...
    def test_get_local_timestamp_success(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch('cloudcasting_backend.services.s3_downloader._TIMESTAMP_FILE', timestamp_file):
    ...
    def test_get_local_timestamp_file_not_found(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch('cloudcasting_backend.services.s3_downloader._TIMESTAMP_FILE', nonexistent_file):
                result = get_local_timestamp()
...
class TestAPIIntegrationFunctions:
    ...
    def test_trigger_background_download_success(self, mock_current_process, mock_run_job):
    ...
    def test_get_download_status_running(self, mock_current_process):
        ...
        with patch('cloudcasting_backend.services.s3_downloader._process_lock'):
            with patch('cloudcasting_backend.services.s3_downloader._TIMESTAMP_FILE') as mock_file:
    ...
    def test_get_current_forecast_folder_exists(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch('cloudcasting_backend.services.s3_downloader.GEOTIFF_STORAGE_PATH', temp_dir):
    ...
    def test_get_current_forecast_folder_not_exists(self):
        ...
        with patch('cloudcasting_backend.services.s3_downloader.GEOTIFF_STORAGE_PATH', nonexistent_path):
            result = get_current_forecast_folder()
...
class TestConstants:
    ...
    def test_constants_defined(self):
        ...
        expected_timestamp_file = Path(GEOTIFF_STORAGE_PATH) / "_last_processed_timestamp.txt"
